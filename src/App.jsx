...
function Router() {
  return <Switch>{<Route path="/" component={Home} />}{<Route path="/about" component={About} />}{<Route path="/services" component={Services} />}{<Route path="/reviews" component={Reviews} />}{<Route path="/blog" component={Blog} />}{<Route path="/blog/:id" component={BlogPost} />}{<Route path="/contact" component={Contact} />}{<Route path="/how-it-works" component={HowItWorks} />}{<Route path="/privacy-policy" component={PrivacyPolicy} />}{<Route path="/terms-and-conditions" component={TermsAndConditions} />}{<Route path="/support" component={Support} />}{<Route path="/disclaimer" component={Disclaimer} />}{<Route path="/faq" component={() => <Redirect to="/about#faq" />} />}{<Route component={NotFound} />}</Switch>;
}
function App() {
